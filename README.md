...
- [Download from Github](https://github.com/hamdiank/TravelingToGetherFront/archive/master.zip).
- Clone the repo: `git clone https://github.com/hamdiank/TravelingToGetherFront.git`.
