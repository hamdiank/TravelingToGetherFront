...
var AvionService = (function () {
    // avionsUrl='http://localhost:8088/avions';
    function AvionService(http, config) {
        this.http = http;
        this.config = config;
    }
    ...
    AvionService.prototype.getById = function (_id) {
        return this.http.get(this.config.apiUrl + '/avions/' + _id, this.jwt()).map(function (response) { return response.json(); });
    };
