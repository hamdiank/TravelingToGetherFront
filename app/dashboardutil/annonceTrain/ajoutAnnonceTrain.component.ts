...
@Component({
    ...
    providers: [ AnnonceTrainService, AnnonceVolService ]
})

export class AjoutAnnonceTrainComponent implements OnInit{
  ...
  ///////////////////////////////////////////////////////////////
   ...
   onSubmit(){  
          ...
          //  console.log(this.model.minutes);
            ...
            this.annonceTrainService.ajouterAnnonceTrain(this.model.heureDepart,this.model.dateDepart,this.model.paysDepart,
            this.model.stationDepart,this.model.paysArrivee, this.model.stationArrivee, this.id )
             .subscribe(
                data => { 
